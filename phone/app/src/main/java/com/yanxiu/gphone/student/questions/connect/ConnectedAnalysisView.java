...
public class ConnectedAnalysisView extends LinearLayout {
    ...
    public ConnectedAnalysisView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ConnectedAnalysisView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public ConnectedAnalysisView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
