...
public abstract class RedoSimpleExerciseBaseFragment extends AnswerExerciseBaseFragment {
    ...
    public void saveAnswer(BaseQuestion question) {
        ...
        if(mAnswerStateChangedListener != null){
            mAnswerStateChangedListener.onAnswerStateChanged(mData);
        }
    }

    public OnAnswerStateChangedListener getAnswerStateChangedListener() {
        return mAnswerStateChangedListener;
    }

    public void setAnswerStateChangedListener(OnAnswerStateChangedListener answerStateChangedListener) {
        mAnswerStateChangedListener = answerStateChangedListener;
    }
