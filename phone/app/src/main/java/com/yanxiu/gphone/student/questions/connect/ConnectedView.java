    ...
    public void addItems(List<ConnectAnalysisItemBean> leftData, List<ConnectAnalysisItemBean> rightData, List<ConnectPositionInfo> connPosInfos) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (leftData.size()>i) {
                ...
                leftText.setText(Html.fromHtml(analysisItemBean.text, new HtmlImageGetter(leftText), null));
            ...
            if (rightData.size()>i) {
                ...
                rightText.setText(Html.fromHtml(analysisItemBean.text, new HtmlImageGetter(rightText), null));
