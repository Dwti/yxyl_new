...
public class ConnectRedoFragment extends AnswerSimpleExerciseBaseFragment {
    ...
    private void showResult() {
        initPopWindow();
        ((MistakeRedoActivity)getActivity()).getOverlayView().setVisibility(View.VISIBLE);
        AlphaAnimationUtil.startPopBgAnimIn(((MistakeRedoActivity)getActivity()).getOverlayView());
