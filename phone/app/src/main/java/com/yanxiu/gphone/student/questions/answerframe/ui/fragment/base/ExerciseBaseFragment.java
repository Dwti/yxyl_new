...
//                    mQaNumber.setVisibility(View.GONE);
                ...
                if(isComplexQuestion){
                    if(mBaseQuestion.getType_id().equals("8") || mBaseQuestion.getType_id().equals("22") || mBaseQuestion.getType_id().equals("24") || mBaseQuestion.getType_id().equals("30")  || mBaseQuestion.getType_id().equals("25")){
                        //如果是解答题或者解决问题 不做任何处理
                    }else {
                        mQaNumber.setVisibility(View.GONE);
                    }
