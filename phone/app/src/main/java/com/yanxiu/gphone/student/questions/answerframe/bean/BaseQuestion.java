    ...
    public BaseQuestion(PaperTestBean bean,QuestionShowType showType,String paperStatus){
        ...
        try {
            ...
            if (jsonNoteBean==null){
                ...
                bean.getQuestions().setJsonNote(jsonNoteBean);
            }
...
//        if (template.equals(QuestionTemplate.CLOZE)) {
        if (isComplexQuestion && !type_id.equals("8") && !type_id.equals("22") && !type_id.equals("24") && !type_id.equals("30") && !type_id.equals("25")) {
            return false;
        }
        return true;
    }
