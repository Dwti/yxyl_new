...
public class OperationRedoFragment extends WrongSimpleExerciseBaseFragment implements AlbumGridView.onClickListener {
    ...
    public View addAnswerView(LayoutInflater inflater, @Nullable ViewGroup container) {
        mAnswerView = inflater.inflate(R.layout.fragment_redo_operation, container, false);
        return mAnswerView;
    }
    ...
    private void initView() {
        ...
        mCheckAnalysis = mAnswerView.findViewById(R.id.ll_check_analysis);
        mCheckAnalysisButton = mAnswerView.findViewById(R.id.btn_check);
        setAnalysisVisible(View.GONE);
    }

    private void listener() {
        mSubjectView.addClickListener(this);
        mCheckAnalysisButton.setOnClickListener(this);
    }
    ...
    private void initData() {
        ...
        if (mData.isMistakeRedoAnalysisExpand()) {
            mCheckAnalysis.setVisibility(View.GONE);
